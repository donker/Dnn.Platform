...
{
    [LoggerMessage(EventId = 15_000_000, Level = LogLevel.Error, Message = "{LogInfo}")]
    ...
    [LoggerMessage(EventId = 15_000_001, Level = LogLevel.Error)]
    public static partial void AnalyticsModuleOnPagePreRenderException(this ILogger logger, Exception exception);

    [LoggerMessage(EventId = 15_000_100, Level = LogLevel.Error, Message = "{LogInfo}")]
